    ...
    >
      ...
      <v-main>
        ...
        <div class="d-flex justify-center align-center my-4">
          ...
          <v-pagination v-model="page" :length="pages" class="mt-4"></v-pagination>
        </v-container>
      </v-main>
    </v-app>
  </template>
  ...
  export default {
    data() {
      return {
        ...
        items: [
          { time: '2024.07.26 11:08:25', type: '소리인식', content: '총 소리 인식 (AKM으로 추정됨)' },
          { time: '2024.07.25 18:07:41', type: '발사기록', content: '포 1발 발사' },
          { time: '2024.07.25 18:08:56', type: '소리인식', content: '총 소리 인식 (AKM으로 추정됨)' },
          { time: '2024.07.25 17:59:16', type: '소리인식', content: '총 소리 인식 (ACE으로 추정됨)' },
          { time: '2024.07.25 13:08:25', type: '소리인식', content: '총 소리 인식 (M762으로 추정됨)' },
          { time: '2024.07.25 11:54:52', type: '센서인식', content: 'UACV 적발 추정' },
          { time: '2024.07.25 11:25:48', type: '발사기록', content: '포 1발 발사' },
          { time: '2024.07.25 11:24:43', type: '소리인식', content: '총 소리 인식 (AKM으로 추정됨)' },
          { time: '2024.07.25 11:08:07', type: '소리인식', content: '총 소리 인식 (M762으로 추정됨)' },
        ],
      };
    },
    methods: {
